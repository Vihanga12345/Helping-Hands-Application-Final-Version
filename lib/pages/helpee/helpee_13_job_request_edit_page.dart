...
class Helpee13JobRequestEditPage extends StatefulWidget {
  ...
  const Helpee13JobRequestEditPage({super.key, this.jobId, this.jobData});
...
class _Helpee13JobRequestEditPageState
  ...
  void _initializeFormData() {
    if (widget.jobData != null) {
      ...
      try {
        _selectedJobType = _getSafeString(
          jobData,
          'category_name',
          'Housekeeping',
        );
        _descriptionController.text = _getSafeString(
          jobData,
          'description',
          '',
        );
        ...
        try {
          ...
          if (timeValue is String) {
            ...
            if (timeString.contains(':')) {
              ...
              final cleanTime = timeString.replaceAll(
                RegExp(r'[APMapm\s]'),
                '',
              );
